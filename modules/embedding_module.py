...
class EmbeddingModule(nn.Module):
    def __init__(self, node_features,
                 # edge_features,
                 memory, neighbor_finder, time_encoder, n_layers,
    ...
    def compute_embedding(self, memory, source_nodes, timestamps, n_layers, n_neighbors=20, time_diffs=None,
                          use_time_proj=True, edge_features=None):
        pass
...
class GraphEmbedding(EmbeddingModule):
    def __init__(self, node_features,
        ...
        super(GraphEmbedding, self).__init__(node_features,
                                             # edge_features,
                                             memory,
                                             neighbor_finder, time_encoder, n_layers,
                                             n_node_features, n_edge_features, n_time_features,
    ...
    def compute_embedding(self, memory, source_nodes, timestamps, n_layers, n_neighbors=20, time_diffs=None,
        ...
        if n_layers == 0:
            ...
            # print("neighbors:",neighbors.shape)#(2680,)
            ...
            edge_features = torch.ones([neighbor_embeddings.shape[0], n_neighbors, 1]).to(self.device)
            # print("source_node_features",source_node_features.shape)#[63, 64]
            # print("source_nodes_time_embedding",source_nodes_time_embedding.shape)#[63, 1, 8]
            # print("neighbor_embeddings",neighbor_embeddings.shape)#[63, 10, 64]
            # print("edge_time_embeddings",edge_time_embeddings.shape)#[63, 10, 8]
            # print("edge_features",edge_features.shape)#[63, 10, 1]
...
# changed
            ...
            return source_embedding,neighbors_torch,_
...
class GraphAttentionEmbedding(GraphEmbedding):
    def __init__(self, node_features,
                 ...
                 n_node_features, n_edge_features, n_time_features, embedding_dimension, device,
                 n_heads=2, dropout=0.1, use_memory=True):
        super(GraphAttentionEmbedding, self).__init__(node_features,
                                                      # edge_features,
                                                      memory,
                                                      neighbor_finder, time_encoder, n_layers,
...
def get_embedding_module(module_type, node_features,
                         # edge_features,
