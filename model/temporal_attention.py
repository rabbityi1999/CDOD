...
class TemporalAttentionLayer(torch.nn.Module):
  ...
  def __init__(self, n_node_features, n_neighbors_features, n_edge_features, time_dim,
    ...
    print("n_neighbors_features:", n_neighbors_features)
    print("time_dim:", time_dim)
    print("n_edge_features:", n_edge_features)
    print("self.query_dim:",self.query_dim)
  ...
  def forward(self, src_node_features, src_time_features, neighbors_features,
    ...
    query = query.permute([1, 0, 2])  # [1, batch_size, num_of_features][1, 63, 72]
    key = key.permute([1, 0, 2])  # [n_neighbors, batch_size, num_of_features][10, 63, 73]
    ...
    return attn_output, attn_output_weights1
